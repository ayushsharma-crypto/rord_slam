...
parser.add_argument(
	'--save_ortho', type=str,
	help='save the generated orthographic img in this path provided'
)
...
def getTopImage(rgbFile, depthFile, final_img_path):
	...
	warpImg, homographyMat = getImgHomo(pcd, T, srcPxs, rgbFile, final_img_path)
...
if __name__ == '__main__':
	...
	warpImg, homographyMat = getTopImage(rgbFile, depthFile, args.save_ortho)
