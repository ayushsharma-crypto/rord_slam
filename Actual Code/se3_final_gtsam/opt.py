...
def optimize(X, Y, Z, Qx, Qy, Qz, Qw):
	...
	# os.system(cmd)
	in_file=os.path.join(dirc, "noise_lc.g2o")
	out_file=os.path.join(dirc, "opt.g2o")
	is3D = True
	graph, initial = gtsam.readG2o(in_file, is3D)
	...
	graph.add(gtsam.PriorFactorPose3(0, gtsam.Pose3(mat=T), priorModel))
	...
	graphNoKernel, _ = gtsam.readG2o(in_file, is3D=True)
	gtsam.writeG2o(graphNoKernel, result, out_file)
	print("Done!")
...
if __name__ == '__main__':
	...
	optimize(X[0], Y[0], Z[0], Qx[0], Qy[0], Qz[0], Qw[0])
